 ...
 */
function gradusone_widgets_init() {
...
add_action( 'widgets_init', 'gradusone_widgets_init' );
...
function red_wp_trim_excerpt( $text ) {
	...
	if ( '' == $text ) {
		...
		$excerpt_end = '<span>[...]</span><p class="read"><a href="' . get_permalink() . '" class="read-more">Read more &rarr;</a></p>'; // modify excerpt ending
